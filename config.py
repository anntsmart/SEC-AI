# API配置
API_TYPE="azure"  # 可选值: "deepseek", "ollama", "azure", "qwen" 或 "gemini"
...
DEEPSEEK_API_KEY=""  # 请添加您的API密钥
# DeepSeek模型名称，官方默认模型: "deepseek-chat"
# 硅基流动：deepseek-ai/DeepSeek-V3
DEEPSEEK_MODEL="deepseek-r1"

# Azure OpenAI API配置
AZURE_API_URL=""  # 请添加您的Azure OpenAI端点
AZURE_API_KEY=""  # 请添加您的Azure OpenAI API密钥
AZURE_API_VERSION="2024-10-21"
AZURE_MODEL="gpt-4o"

# 通义千问 API配置
QWEN_API_URL="https://dashscope.aliyuncs.com/compatible-mode/v1/chat/completions"
QWEN_API_KEY=""  # 请添加您的通义千问API密钥
...
GEMINI_API_KEY=""  # 请添加您的Gemini API密钥
